...
export default function EnhancedManagementDashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, activityRes, alertsRes] = await Promise.allSettled([
        ...
        axios.get('/api/dashboard/activity', { params: { limit: 10, period } }),
      ...
      if (alertsRes.status === 'fulfilled') {
        setSystemAlerts(alertsRes.value.data);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6">
      {/* Header */}
      <Card className="shadow-xl border-0 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white mb-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <Space className="flex-wrap">
            ...
            <Button 
              ...
              loading={loading}
              className="w-full lg:w-auto bg-white/20 border-white/30 text-white hover:bg-white/30"
              size="large"
            >
              Refresh
            </Button>
        ...
        <Row gutter={[24, 24]}>
          {quickActions.map((action, index) => (
            <Col xs={24} sm={12} lg={8} key={index}>
              <Card
                hoverable
                className="text-center border-0 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
                onClick={() => handleQuickAction(action.path)}
                bodyStyle={{ padding: '32px 24px' }}
              >
                <div className={`p-6 bg-gradient-to-br ${action.gradient} rounded-2xl mb-6 inline-block`}>
                  {action.icon}
                </div>
      ...
      >
        ...
        >
          <Row gutter={[24, 24]}>
            <Col xs={24} lg={12}>
              <Card title="User Growth" className="shadow-lg border-0">
                <div className="text-center py-8">
                  <div className="mb-4">
                    <TrendingUpOutlined style={{ fontSize: '48px', color: '#52c41a' }} />
                  </div>
            ...
            <Col xs={24} lg={12}>
              <Card title="Department Overview" className="shadow-lg border-0">
                <div className="space-y-4">
        ...
        >
          <Row gutter={[24, 24]}>
            <Col xs={24} lg={16}>
              <Card title="File Statistics" className="shadow-lg border-0">
                <Row gutter={[16, 16]}>
                  <Col xs={24} sm={12}>
                    <div className="text-center p-6 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl text-white">
                  ...
                  <Col xs={24} sm={12}>
                    <div className="text-center p-6 bg-gradient-to-br from-green-500 to-teal-500 rounded-xl text-white">
                      <Title level={2} className="text-white mb-2">
            ...
            <Col xs={24} lg={8}>
              <Card title="Storage Breakdown" className="shadow-lg border-0">
                <div className="space-y-4">
        ...
        >
          <Row gutter={[24, 24]}>
            <Col xs={24}>
              <Card title="System Alerts" className="shadow-lg border-0">
                          ...
                          description={
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-2 text-sm text-gray-500">
                                ...
                                {!alert.acknowledged && (
                                  <Tag color="red" size="small">Unacknowledged</Tag>
                                )}
                              </div>
                            </div>
                          }
